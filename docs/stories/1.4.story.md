...
### File List
- app/src/services/api/queryClient.ts (React Query configuration)
- app/src/hooks/useAuth.ts (Authentication hooks)
- app/src/hooks/useHabitTracking.ts (Habit tracking hooks)
- app/src/hooks/useOfflineSync.ts (Offline synchronization hooks)
- app/src/hooks/useQueryState.ts (State management utilities)
- app/src/utils/queryHelpers.ts (Query helper utilities and patterns)
